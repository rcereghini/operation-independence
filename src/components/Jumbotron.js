    ...
    return (
      <div class="jumbotron">
        <div>
          ...
          <p class="lead subTitleText">Become a Founder Today to Receive Exclusive Offers!</p>
          <hr class="my-4"/>
          ...
          <a class="btn btn-primary btn-lg learnMoreButton" href="#" role="button">Learn more</a>
        </div>
      </div>
    );
  }
